...
const HotelInfo = ({ selectedHotelId }: HotelInfoProps) => {
	...
	const apiCode = selectedIntegration?.code as string as keyof AccommodationMapping["boards"] | keyof AccommodationMapping["rooms"];
										...
										return (
											<div key={boardCode}>
												...
												<input
													type="text"
													value={
														accommodationsMap?.boards[Number(boardCode)]?.[apiCode as keyof Board] || ''
													}
													name="boards"
								...
								Object.keys(accommodationsMap?.rooms).map((el) => {
									return (
										<div key={el}>
											...
											<input
												type="text"
												value={accommodationsMap.rooms[el]?.[apiCode as keyof Room] || ''}
												name="rooms"
