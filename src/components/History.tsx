...
const History = () => {
    ...
    const [params, setParams] = useState<SearchBookingsParams>({ booking: '', dateFrom: '', dateTo: '', limit: 100, skip: 0, isByDate: "yes" });
    ...
    return (
        <>
            ...
            <div className={styles.historyTopWrap}>
                ...
                <SearchForm setBookingsArr={setBookingsArr} params={params} setParams={setParams} />
            </div>
            <View bookingsArr={bookingsArr} params={params} />
            <Pagenation bookingsArr={bookingsArr} setBookingsArr={setBookingsArr} params={params} setParams={setParams} />
            {/* </PageTemplate> */}
        </>
    )
}
